...
class TRANSFORM_v2(object):
    ...
    def __init__(self):
        ...
        self.level_coef_dict = {"id": self.get_ratios(coef=0.3), "item_id": self.get_ratios(coef=0.15),
                               "dept_id": self.get_ratios(coef=0.08), "cat_id": self.get_ratios(coef=0.07),
                               "store_id": self.get_ratios(coef=0.08), "state_id": self.get_ratios(coef=0.07), "_all_": self.get_ratios(coef=0.05),
                               ("state_id", "item_id"): self.get_ratios(coef=0.19),  ("state_id", "dept_id"): self.get_ratios(coef=0.1),
                                ("store_id","dept_id") : self.get_ratios(coef=0.11), ("state_id", "cat_id"): self.get_ratios(coef=0.08),
